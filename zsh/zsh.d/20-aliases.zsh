...
alias claude='omc update && ANTHROPIC_DEFAULT_OPUS_MODEL="claude-opus-4-6[1m]" CLAUDE_CODE_EFFORT_LEVEL="max" IS_SANDBOX=1 command claude --dangerously-skip-permissions --model "claude-opus-4-6[1m]" --effort max'
