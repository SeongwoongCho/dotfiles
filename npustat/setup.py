...
if os.getenv("NPUSTAT_VERSION"):
    # release process, e.g. NPUSTAT_VERSION="1.1" python setup.py sdist
    __version__ = os.environ["NPUSTAT_VERSION"]
else:
...
class DeployCommand(Command):
    ...
    def run(self):
        ...
        os.system("NPUSTAT_VERSION='{}' sh -c '{} setup.py sdist'".format(
...
setup(
    ...
    version=__version__,
    license='MIT',
    description='An utility to monitor NVIDIA GPU and Mobilint NPU status and usage',
    long_description=read_readme(),
    long_description_content_type='text/markdown',
    url='https://github.com/wookayin/gpustat',
    author='Jongwook Choi',
    author_email='wookayin@gmail.com',
    keywords='nvidia-smi gpu cuda npu mobilint monitoring npustat gpustat',
    classifiers=[
